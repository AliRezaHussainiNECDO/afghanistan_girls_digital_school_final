...
async function gradeWithGemini(
  ...
  const prompt =
    `شما یک معلم مهربان افغان هستید. تصویر زیر دست‌خط یک شاگرد است که به این سؤال پاسخ داده: ` +
    `«${questionText}». وظیفهٔ شما:\n` +
    `۱) متن دست‌نویس را از روی عکس دقیقاً بخوانید (OCR) — اگر به دری/پشتو نوشته شده همان‌طور بنویسید.\n` +
    `۲) پاسخ را از ۰ تا ۱۰۰ نمره بدهید (صحت، مراحل حل، خوانایی).\n` +
    `۳) یک بازخورد کوتاه، مهربان و سازنده به زبان دری بنویسید (۲ تا ۴ جمله) — نقاط قوت و آنچه باید بهتر شود.\n\n` +
